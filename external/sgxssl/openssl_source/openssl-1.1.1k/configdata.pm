...
our %config = (
  AR => "ar",
  ARFLAGS => [ "r" ],
  CC => "/home/nskernel/llvm-project/build/bin/clang",
  CFLAGS => [ "-Wall -O3", "-include/media/nskernel/HDDBANK/linux-sgx-san/external/sgxssl/Linux/../openssl_source/bypass_to_sgxssl.h" ],
  CPPDEFINES => [ "_FORTIFY_SOURCE=2", "GETPID_IS_MEANINGLESS" ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "/home/nskernel/llvm-project/build/bin/clang++",
  CXXFLAGS => [ "-Wall -O3", "-include/media/nskernel/HDDBANK/linux-sgx-san/external/sgxssl/Linux/../openssl_source/bypass_to_sgxssl.h" ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/home/nskernel/llvm-project/build/bin/clang",
  minor => "1.1",
  ...
  prefix => "/media/nskernel/HDDBANK/linux-sgx-san/external/sgxssl/Linux/../openssl_source/OpenSSL_install_dir_tmp",
  processor => "",
